...
`checksRun`/`checksTotal` count **checks**, not the analysis: 185 of 185 checks can run on
...
- **Two units per subject, and both are named (B-565).** `skills`/`mcp`/`plugins` count
  ...
  run. 68 of the catalog's 189 entries (skills 55 + mcp 13) appeared in neither the numerator
