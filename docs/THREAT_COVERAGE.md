...
all (so they can't even surface as a finding). Updated 2026-07-19 for v3.53.0.

Current catalog: A1 plus the B-series, C-series, and T-series (behavioral) — 146 catalogued,
of which **143 run in a default audit**; the three T-series behavioral checks execute only
under `--behavioral`
