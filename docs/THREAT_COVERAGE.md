...
Current catalog: A1 plus the B-series, C-series, and T-series (behavioral) — 151 catalogued,
of which **148 run in a default audit**; the three T-series behavioral checks execute only
under `--behavioral`
