...
Current catalog: A1 plus the B-series, C-series, and T-series (behavioral) — 148 catalogued,
of which **145 run in a default audit**; the three T-series behavioral checks execute only
under `--behavioral`
