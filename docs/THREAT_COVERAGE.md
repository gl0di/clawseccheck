...
| Content-security ring — prompt-injection-shaped directives | B58, B59, B60, B61, B62, B63, B64, B65, B66, B67, B74, B91, B95 | Unicode-obfuscated hidden text (B58), markdown-image data-exfil (B59), self-replication (B60), cross-agent config snooping (B61), capability-intent mismatch (B62), silent-instruction (B63), instruction-hierarchy override (B64), sleeper-trigger (B65), persona jailbreak (B66), per-source trust contracts (B67), forged-provenance content (B74), dynamic-dispatch sink obfuscation (B91), dependency confusion (B95) `[CHECK: B58, B59, B60, B61, B62, B63, B64, B65, B66, B67, B74, B91, B95]` |
