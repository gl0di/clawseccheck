...
<p align="center">
  <picture>
    ...
    <img src="docs/assets/stats-light.svg" alt="165 security checks · 22 attack-chain detectors · 10,600 automated tests · 0 dependencies · 0 network calls" width="900">
  </picture>
</p>
...
On top of the 165 individual checks, a **risk engine** hunts for deadly
...
- **Built like it matters.** 10,600 automated tests run on every change, a
...
| [Check catalog](docs/CHECKS.md) | All 165 checks: what they verify and how to remediate |
