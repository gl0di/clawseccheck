...
<p align="center">
  <picture>
    ...
    <img src="docs/assets/stats-light.svg" alt="152 security checks · 20 attack-chain detectors · 7,836 automated tests · 0 dependencies · 0 network calls" width="900">
  </picture>
</p>
...
On top of the 152 individual checks, a **risk engine** hunts for deadly
...
- **Built like it matters.** 7,836 automated tests run on every change, a
...
| [Check catalog](docs/CHECKS.md) | All 152 checks: what they verify and how to remediate |
