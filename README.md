...
<p align="center">
  <picture>
    ...
    <img src="docs/assets/stats-light.svg" alt="222 security checks · 26 attack-chain detectors · 26,675 automated tests · 0 dependencies · 0 network calls · OpenClaw 2026.9.4 verified" width="900">
  </picture>
</p>
...
On top of the 222 individual checks, a **risk engine** hunts for deadly
...
- **Built like it matters.** 26,675 automated tests run on every change, a
...
| [Check catalog](docs/CHECKS.md) | All 222 checks: what they verify and how to remediate |
