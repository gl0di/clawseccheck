...
<p align="center">
  <picture>
    ...
    <img src="docs/assets/stats-light.svg" alt="166 security checks · 22 attack-chain detectors · 11,009 automated tests · 0 dependencies · 0 network calls" width="900">
  </picture>
</p>
...
On top of the 166 individual checks, a **risk engine** hunts for deadly
...
- **Built like it matters.** 11,009 automated tests run on every change, a
...
| [Check catalog](docs/CHECKS.md) | All 166 checks: what they verify and how to remediate |
