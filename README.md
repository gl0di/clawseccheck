...
<p align="center">
  <picture>
    ...
    <img src="docs/assets/stats-light.svg" alt="195 security checks · 26 attack-chain detectors · 22,810 automated tests · 0 dependencies · 0 network calls · OpenClaw 2026.9.3 verified" width="900">
  </picture>
</p>

<p align="center">
  <sub>Verified against <b>OpenClaw 2026.9.3</b> on <b>Linux</b> · also reads the pre-2026.8.1 config shapes · Python 3.9+ · <a href="#-compatibility">details</a></sub>
</p>
...
On top of the 195 individual checks, a **risk engine** hunts for deadly
...
- **Built like it matters.** 22,810 automated tests run on every change, a
...
| [Check catalog](docs/CHECKS.md) | All 195 checks: what they verify and how to remediate |
