...
<p align="center">
  <picture>
    ...
    <img src="docs/assets/stats-light.svg" alt="186 security checks · 26 attack-chain detectors · 16,800 automated tests · 0 dependencies · 0 network calls" width="900">
  </picture>
</p>
...
On top of the 186 individual checks, a **risk engine** hunts for deadly
...
- **Built like it matters.** 16,800 automated tests run on every change, a
...
| [Check catalog](docs/CHECKS.md) | All 186 checks: what they verify and how to remediate |
