...
_EXEMPT = {
    ...
    "checks/_vet.py": "~9,696 lines (restated 2026-09-26, table-cells round 4 "
                      "(CLAWSECCHECK, fix/fleetfp-fetch-table-cells) — was ~9,185; "
                      "closing the round-4 C-135 blocker (a directive line preceding an "
                      "unrelated real table was wrongly pipe-split) required replacing "
                      "the single whole-run `has_delim` flag in "
                      "_runtime_fetch_table_pipe_breaks with a pair-based header/"
                      "delimiter walk plus a new _gfm_row_cell_count helper, both with "
                      "spec-grounding docstrings; added ~52 lines); and before that "
                      "restated 2026-09-24, B-879 round 5 — was ~9,165; "
