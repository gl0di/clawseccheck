...
_EXEMPT = {
    ...
    "checks/_vet.py": "~9,699 lines (restated 2026-09-26, table-cells C-135 round 2 — "
                      "was ~9,185 (already stale by ~360-435 lines across the "
                      "intervening, unrestated table-cells round 1 fix — within the "
                      "500-line slack until this round-2 change pushed it out); the "
                      "code-span-aware cell-boundary fix for "
                      "_runtime_fetch_table_pipe_breaks — new _gfm_line_code_span_ranges "
                      "and _offset_in_code_span helpers, plus docstring updates — added "
                      "~84 lines); and before that restated 2026-09-24, B-879 round 5 — "
                      "was ~9,165; "
