...
_EXEMPT = {
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~16,902 lines (further restated 2026-09-25 on top of "
                   "the 2026-09-24d restatement below: B-998 round 3 added "
                   "`hardcoded_env_secret_is_inert` and its G0-G4 helper functions -- a "
                   "self-contained positive reachability proof, in checks/_vet.py's own "
                   "B-998 arm, that every HARDCODED_PROVIDER_SECRET env-write a "
                   "test-fixture-named file was flagged for never reaches a network-send "
                   "call, a return/yield, or any other node the proof cannot positively "
                   "clear -- replacing the two earlier, retracted rounds (a bare basename "
                   "carve-out, then a file-wide _EXFIL_RE token scan) neither of which could "
                   "distinguish a genuinely inert test fixture from one that actually "
                   "laundered the value to a sink. "
                   "16,213 lines (further restated 2026-09-24d on top of "
