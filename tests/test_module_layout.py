...
_EXEMPT = {
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~9,732 lines (restated 2026-09-23, B-850 round 3 — was ~9,150; the "
                   "addition is the resolution-based fail-closed guard rewrite (chases "
                   "import/sys.modules/importlib aliasing instead of matching by name "
                   "spelling) plus the walrus binding-order/dead-code-skip fix, both "
                   "still inside the same self-contained abstract-interpretation engine "
                   "the 2026-09-16 restatement below describes, not a new parser family) "
                   "— the python/shell/js parser families; its own split is "
