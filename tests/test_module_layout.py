...
_EXEMPT = {
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~12,448 lines (restated 2026-09-24, B-894 -- was ~11,796; the addition "
                   "is the shell for-loop credential-taint engine for SHELL_CRED_EXFIL "
                   "(~650 lines: continuation-join/heredoc-blank/code-mask lexical prep, "
                   ...
                   "literal twin still convicts) -- the shell family, not python/js, and no "
                   "new parser). Restated 2026-09-23, merging three concurrent growth lines "
