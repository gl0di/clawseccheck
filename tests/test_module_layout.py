...
_EXEMPT = {
    ...
    "checks/_vet.py": "~9,165 lines (restated 2026-09-24, CLAWSECCHECK-B-879 round 4 — "
    ...
    "checks/_shared.py": "~5,805 lines (restated 2026-09-24, CLAWSECCHECK-B-879 round 4 — "
                         "was ~5,014; added the ProseBinding clause-role primitive "
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~14,877 lines (restated 2026-09-24, merging four concurrent growth "
