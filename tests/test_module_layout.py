...
_EXEMPT = {
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~14,078 lines (restated 2026-09-24, +501 over the same-day B-863/"
                   "B-894 restatement below from B-935 rounds 1-4: the literal, "
                   ...
                   "catch.\n"
                   "~13,577 lines (restated 2026-09-24, merging two concurrent growth "
                   "lines from a common ~11,796-line baseline: B-863 round 4 and B-894. "
                   ...
                   "Neither line adds a new parser family. Previously restated "
