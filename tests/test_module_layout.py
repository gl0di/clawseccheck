...
_EXEMPT = {
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~10,245 lines (restated 2026-09-23, B-850 round 5 — was ~9,732 as of "
                   "round 3; round 4 (9fc20cc9) added the ambiguous-fires provenance "
                   "walker backing the fail-closed guard's mutation-target check (~395 "
                   "lines) without restating this entry, and round 5 wired the .__dict__/"
                   "subscript-store gates onto that same combinator plus traced the Call "
                   "branch's function-return/class-constructor provenance (~120 lines) — "
                   "both still inside the same self-contained abstract-interpretation "
                   "engine the 2026-09-16 restatement below describes, not a new parser "
                   "family) — the python/shell/js parser families; its own split is "
