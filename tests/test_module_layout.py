...
_EXEMPT = {
    ...
    "checks/_vet.py": "~7,922 lines (restated 2026-09-23, CLAWSECCHECK-B-649 port to "
    ...
    "skillast.py": "~8,413 lines (restated 2026-09-23, B-830 round 2 — was ~7,875; the "
                   ...
                   "of crashing --vet-skill with no verdict, plus threading the fold context "
                   "into the in-cluster credential classifier so a folded extension of the "
                   "in-cluster token literal cannot misclassify as exempt — the same taint "
                   "layer the note below already tracks, not a new parser family). Restated "
                   "2026-09-16, B-643 — was ~7,267; the addition is "
