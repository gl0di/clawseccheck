...
_EXEMPT = {
    ...
    "checks/_vet.py": "~9,813 lines (restated 2026-09-26, fix/fleetfp-crontab-operand "
                      "round 4 — was ~9,185; a fresh C-135 pass on round 3's bracket/"
                      "paren-shape link-label regex found it could be fooled by "
                      "backslash-escaped brackets and an unclosed destination, so it was "
                      "replaced with a small CommonMark-faithful structural parser — five "
                      "new private helpers "
                      "(_cron_link_preceding_backslash_count/_cron_link_is_escaped/"
                      "_cron_link_code_span_ranges/_cron_link_pos_in_spans/"
                      "_cron_link_destination_close) plus the rewritten "
                      "_cron_hit_in_link_label and an expanded design comment; added ~206 "
                      "net lines); and before that restated 2026-09-24, B-879 round 5 — "
                      "was ~9,165; "
