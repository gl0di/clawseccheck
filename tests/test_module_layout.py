...
_EXEMPT = {
    ...
    "checks/_vet.py": "~9,958 lines (restated 2026-09-26 on integration/4.3.0 after "
                      "merging two fleet-FP fixes — was ~9,185: the vet-example-prohibition "
                      ...
                      "sibling (~540 lines, mostly docstring), and the table-cells GFM "
                      "header/delimiter pair walk with _gfm_row_cell_count (~52 lines) — "
