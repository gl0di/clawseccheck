...
_EXEMPT = {
    ...
    "risk.py": "~2,937 lines (restated 2026-09-17 — was ~2,421) — the combinational "
               ...
               "cycle.",
    "skillast.py": "~14,129 lines (restated 2026-09-24, merging three concurrent growth "
                   "lines from a common ~11,796-line baseline: CLAWSECCHECK-B-906, B-863 "
                   "round 4, and B-894. B-906 (+523) added `_RefResolver` — positive-only "
