...
_EXEMPT = {
    ...
    "checks/_shared.py": "~1,250 lines — the leaf every checks/_<topic> module (and "
                         ...
                         "cycle.",
    "checks/_capability.py": "~1,230 lines — the declared-vs-effective capability / "
                             "manifest topic (B55/B68/B326 + helpers). Crossed the budget "
                             "with CLAWSECCHECK-B-376/B-369's B55 WARN->FAIL escalation: an "
                             "independent C-135 adversarial pass found and fixed 2 real "
                             "false-positive root causes (tools.elevated.allowFrom's real "
                             "dict-per-provider shape; B68's own fs-confinement predicate) "
                             "that the fix needed in place, in the same function, to be "
                             "sound. A finer split is a later cycle.",
