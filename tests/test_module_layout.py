...
_EXEMPT = {
    ...
    "checks/_vet.py": "~9,723 lines (restated 2026-09-26, CLAWSECCHECK "
                      "fleetfp-fixes/vet-example-prohibition round 2 — was ~9,185; scoping "
                      "the scanner-finding-line recognizer out of _in_example_context's "
                      "unconditional branch into a caller-opt-in `scanner_finding_line_ok` "
                      "parameter (a C-135 blocker: it had leaked into the injection-directive "
                      "standalone arm and the TR1 broad-trigger arm, which never asked for "
                      "it), plus the new _example_context_is_scanner_finding_line_only "
                      "sibling that demotes the still-ambiguous same-arm case to WARN "
                      "instead of a silent PASS, added ~540 lines, mostly docstring/comment "
                      "explaining why the scoping and the WARN-not-PASS demotion are each "
                      "needed — no new detection, an existing arm's dampening made sound); "
