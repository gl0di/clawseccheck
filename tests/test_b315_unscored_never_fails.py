...
def test_catalog_scored_false_ids_match_the_audited_set():
    ...
    # check in this set. +1: B387 (F-196, secrets.egressProxy traffic-allowlist gap) —
    # WARN-only, never FAIL (the schema itself rejects a wildcard in allowedHosts/
    # bypassHosts, so there is no FAIL-worthy shape).
